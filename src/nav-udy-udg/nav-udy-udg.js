...
// import '../nav-udy-udg/udyam_nav.svg';
// import '../nav-udy-udg/udgam_nav.svg';
...
const Nav_udy_udg = (props) => {
  // const whichevent=props.whichevent;
  //   let titleimg="";
  //   if(props.whichevent=='udyam'){
  //       titleimg={udyam};
  //   }else{
  //       titleimg={udgam};
  //   }
      ...
      {(slideNav || width > 800) && (
        <div className="udyam-nav">
          ...
          <div className="udyam-img">
            <Link to={'/'.concat(props.whichevent)} style={{ textDecoration: 'none' }}>
              <img className="udyam-logo" src={props.whichevent == 'udyam' ? udyam : udgam} alt="title-img" />
            </Link>
          </div>
          <div className="udyam-icon">
            ...
            >
              <Link to={'/'.concat(props.whichevent, '/about')} className="game-changer" style={{ textDecoration: 'none' }}>
                {' '}
            ...
            <div className="events hovered" id={props.active === '#event' ? 'active' : ''} onClick={events}>
              <Link to={'/'.concat(props.whichevent, '/events')} className="game-changer" style={{ textDecoration: 'none' }}>
            ...
            >
              <Link to={'/'.concat(props.whichevent, '/sponsors')} className="game-changer" style={{ textDecoration: 'none' }}>
                <BiDollarCircle className="info" />
                <p>Sponsors</p>
              </Link>
            </div>
            <div className="leaderboard hovered" id={props.active === '#leaderboard' ? 'active' : ''}>
              <Link to={'/'.concat(props.whichevent, '/leaderboard')} className="game-changer" style={{ textDecoration: 'none' }}>
