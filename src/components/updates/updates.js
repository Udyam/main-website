    ...
    <>
      ...
      <section className="updates-main-container">
        ...
        <div className="updates-udyam-content">
          ...
          <p>
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Cupiditate suscipit distinctio
            facilis voluptate? Reprehenderit esse commodi quo temporibus, ad fugiat.
          </p>
        </div>
